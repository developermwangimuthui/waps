                                ...
                                <div class="card-body">
                                    <form class="theme-form" action="{{ route('customer.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="surname" type="text" placeholder="Enter Surname"
                                                name="surname">
                                        </div>
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0" for="country">Country</label>
                                            <input class="form-control" id="country" type="text" placeholder="Enter Country"
                                                name="country">
                                        </div>
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0" for="county">County</label>
                                            <input class="form-control" id="county" type="text" placeholder="Enter County"
                                                name="county">
                                        </div>
                                        <div class="mb-3">
