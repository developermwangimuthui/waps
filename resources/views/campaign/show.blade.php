...
@section('content')
    @foreach ($campaigns as $campaign)
        @php
            ...
            //     ->first();
            // Driver Information
            $driver_id = $campaign->driver->id;

            $driver_user_id = \App\Models\Driver::where('id', $driver_id)
                ->pluck('user_id')
                ->first();
                                        ...
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <h4 class="f-w-500 mb-0 f-26"><span
                                                        class="counter">{{ $campaign->goal }}</span></h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card o-hidden">
                                    <div class="card-body">
                                        @foreach ($drivers as $driver)
                                            <div class="media">
                                                <div class="media-body">
                                                    <p class="f-w-500 font-roboto">Driver</p>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="avatars">
                                                                <div class="avatar">
                                                                    <img class="img-50 rounded-circle table-img"
                                                                        src="{{ URL::to('/') }}/DriverPhotos/{{ $driver_image }}"
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="progress-box">
                                                                <p>
                                                                    <span>Phone Number:{{$driver->phone}}
                                                        &nbsp; Email :{{ $driver->phone}}</span></p>
